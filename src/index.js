...
async function main(req) {
    ...
    var priceLower = req.priceLower;
    var priceUpper = req.priceUpper;
    switch (platform) {
        case "testnetftmscan":
        ...
        // Raydium
        case "Raydium":
            rpc_url = process.env.SolonaRpcUrl;
            private_key = process.env.SolanaPRIVATEKEY;
    ...
    switch (method) {
        ...
        case "liquidityAdd":
            ...
            amount1 = req.amount1;
            amount2 = req.amount2;
            request = { platform, pair, method, pool, farm, address1, address2, amount1, amount2, private_key, rpc_url, version, tokenId, positionId,tickLower,tickUpper, priceLower, priceUpper };
            break;
        case "liquidityRemove":
            address1 = req.address1;
            address2 = req.address2;
            liquidity = req.liquidity;
            request = { platform, pair, method, pool, farm, address1, address2, liquidity, private_key, rpc_url, version, tokenId, positionId };
            break;
        case "farmingDeposit":
            address1 = req.address1;
            address2 = req.address2;
            ...
            break;
        case "farmingHarvest":
            request = { platform, pair, method, pool, farm, private_key, rpc_url, version, tokenId, positionId };
            break;
