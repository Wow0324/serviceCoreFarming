...
data = fs.readFileSync(__dirname + "/abi/SunIoRouter.json", 'utf-8');
const Routerabi = JSON.parse(data);
data = fs.readFileSync(__dirname + "/abi/SunIoFactory.json", 'utf-8');
...
//=========================================================
const ExchangeFactoryAddr = Addresses.SUNIoExchangeFactory;
const ExchangeRouterAddr = Addresses.SUNIoExchangeRouter;
const cakeVaultAddr = Addresses.SUNIoVault;
const masterchefAddr = Addresses.SUNIomasterchef;
const UsdtAddr = Addresses.SUNIoUsdt;
const {
    readLPInformation,
    writeLPInformation,
    SUNIoGetpIdFromPairName,
    SUNIoGetAddressFromPairName
...
exports.statusGet = async (req) => {
    ...
    const { addr1, addr2 } = SUNIoGetAddressFromPairName(pair);
    ...
    try {
        ...
        if (farm == "1") {
            try {
                ...
                var pid = SUNIoGetpIdFromPairName(pair);
