...
//=========================================================
const ExchangeFactoryAddr = Addresses.SushiSwapExchangeFactory;
const ExchangeRouterAddr = Addresses.SushiSwapExchangeRouter;
const cakeVaultAddr = Addresses.SushiSwapVault;
const masterchefAddr = Addresses.SushiSwapmasterchef;
const UsdtAddr = Addresses.SushiSwapUsdt;
const {
    readLPInformation,
    writeLPInformation,
    SushiswapGetpIdFromPairName,
    SushiswapGetAddressFromPairName
...
exports.statusGet = async (req) => {
    ...
    const { addr1, addr2 } = SushiswapGetAddressFromPairName(pair);
    ...
    try {
        ...
        if (farm == "1") {
            try {
                ...
                var pid = SushiswapGetpIdFromPairName(pair);
