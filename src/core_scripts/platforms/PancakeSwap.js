...
//=========================================================
const ExchangeFactoryAddr = Addresses.PancakeSwapExchangeFactory;
const ExchangeRouterAddr = Addresses.PancakeSwapExchangeRouter;
const cakeVaultAddr = Addresses.PancakeSwapcakeVault;
const masterchefAddr = Addresses.PancakeSwapmasterchef;
    ...
    try {
        ...
        if (farm == "1") {
            try {
                ...
                var pid = PancakeswapGetpIdFromPairName(pair);
