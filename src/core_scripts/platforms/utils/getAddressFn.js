...
exports.TradeJoeGetFeeFromPairName = function (pair) {
    ...
    switch (pair) {
        case "AVAX-USDT":
        case "USDT-AVAX":
            fee = 0.2;//pair address : 
            break;
        case "AVAX-JOE":
        case "JOE-AVAX":
            pid = 0.15; //pair address : 
            break;
        case "WETH-AVAX":
        case "AVAX-WETH":
            pid = 0.1; //pair address : 
            break;
        case "JOE-USDC"://
        case "USDC-JOE"://
            pid = 0.25;//pair address : 
            break;
        case "AVAX-USDC"://
        case "USDC-AVAX"://
            pid = 0.2;//pair address : 
            break;
        case "AVAX-BTC"://
        case "BTC-AVAX"://
            pid = 0.1;//pair address : 
...
//========================= Raydium======================
exports.RaydiumGetAddressFromPairName = function (pair) {
    var addr1 = "";
    var addr2 = "";
    switch (pair) {
        case "SOL-USDC":
            addr1 = Addresses.RaydiumWSOL;
            addr2 = Addresses.RaydiumUsdc;
            break;
        case "USDC-USDT":
            addr1 = Addresses.RaydiumUsdc;
            addr2 = Addresses.RaydiumUsdt;
            break;
        case "RAY-USDC":
            addr1 = Addresses.RaydiumRay;
            addr2 = Addresses.RaydiumUsdc;
            break;
        case "SOL-RAY":
            addr1 = Addresses.RaydiumWSOL;
            addr2 = Addresses.RaydiumRay;
            break;
        default:
            break;
    }
...
exports.RaydiumGetFeeFromPairName = function (pair) {
    var fee = 0;
    switch (pair) {
        case "SOL-USDC":
            fee = 0.05;// %  pair address : 
