...
const {
    ...
    MIN_TICK, Q128, Q64, U64Resolution,
} = require('./constants');
...
class SqrtPriceMath {
    ...
    static getNextSqrtPriceX64FromInput(
        sqrtPriceX64,
        liquidity,
        amountIn,
        zeroForOne
    ...
    static getNextSqrtPriceX64FromOutput(
        sqrtPriceX64,
        liquidity,
        amountOut,
        zeroForOne
...
class LiquidityMath {
    ...
    static getLiquidityFromTokenAmountA(
        sqrtPriceX64A,
        sqrtPriceX64B,
        amountA,
        roundUp
    ...
    static getLiquidityFromTokenAmountB(
        sqrtPriceX64A,
        sqrtPriceX64B,
        amountB
    ) {
